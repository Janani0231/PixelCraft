      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            ...
            <a href="#gallery" className="hover:text-primary-400 transition-colors">Gallery</a>
            <a href="#tutorials" className="hover:text-primary-400 transition-colors">Tutorials</a>
        ...
        >
          <p>© {new Date().getFullYear()} PixelCraft. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
